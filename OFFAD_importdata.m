...
uicontrol(g.Import,'Style', 'popup','String',var2options,...
    ...
    'Units','normalized',...
    'Tag','var2',...
    'Position',[0.62 centres(7)-boxHeighthhalf 0.2 boxHeighthhalf*2],'Callback',[ 'tagfs = ''var2Fs'';' 'tag1 = ''var2'';' variableChange ]);
...
uicontrol(g.Import,'Style', 'pushbutton','String','Done',...
    ...
    'Position',[0.75 centres(9)-boxHeighthhalf 0.2 boxHeighthhalf*2],'Callback','[OFFDATA]=OFFAD_preclustering([findobj(''parent'',gcbf,''type'', ''UIControl'')]);');
