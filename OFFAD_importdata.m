...
... %	'Colormap','gray', ...
	...
	'PaperUnits','points', ...
	'name', 'OFFAD (OFF_period Automated Detection) - Import', ... 
	'numbertitle', 'off', ...
...
uicontrol(g.Import,'Style','popupmenu','String',{'uV','uV*1000000'},...
    'FontSize',12,...
    'Units','normalized',...
...
uicontrol(g.Import,'Style', 'popup','String',var1options,...
    ...
    'Units','normalized',...
    'Tag','var1',...
    'Position',[0.23 centres(8)-boxHeighthhalf 0.2 boxHeighthhalf*2],'Callback',[ 'tagfs = ''var1Fs'';' 'tag1 = ''var1'';' variableChange ]);
...
uicontrol(g.Import,'Style', 'popup','String',var2options,...
    ...
    'Units','normalized',...
    'Tag','var2',...
    'Position',[0.62 centres(8)-boxHeighthhalf 0.2 boxHeighthhalf*2],'Callback',[ 'tagfs = ''var2Fs'';' 'tag1 = ''var2'';' variableChange ]);
